...
export BASE_PATH=${BASE_PATH:-/home/dist/chenyonghua}
export PATCH_HOME=/home/dist/yanguo.sun/35141/chenyonghua/llama2_7b/megatron_train/megatron-lm-musa-patch
export MEGATRON_PATH=${PATCH_HOME}/../Megatron-LM
export PYTHONPATH=/home/dist/chenyonghua/LLM-Train-Eval/pretrain:${MEGATRON_PATH}:${PATCH_HOME}:$PYTHONPATH
