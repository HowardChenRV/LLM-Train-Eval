...
TOKENIZER_MODEL=${BASE_PATH}/Mixtral-8x7B-v0.1/tokenizer.model
CHECKPOINT_PATH=${BASE_PATH}/Mixtral-8x7B-save-point
DATA_PATH=${BASE_PATH}/RedPajama-Data-1T-Sample-datasets/RedPajama-Data-Llama
...
LOGGING_ARGS=(
    ...
    --no-load-optim
    --no-load-rng
    --wandb-project nvidia_A800-megatron_r0.8.0-mixtrial_${MODEL_SIZE}b
