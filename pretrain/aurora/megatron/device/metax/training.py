# 2024 - Modified by MetaX Integrated Circuits (Shanghai) Co., Ltd.  && INFINI-AI All Rights Reserved.
...
def setup_model_and_optimizer(model_provider_func,
    ...
    if (args.load is not None or args.pretrained_checkpoint is not None) and not args.train_from_scratch:
